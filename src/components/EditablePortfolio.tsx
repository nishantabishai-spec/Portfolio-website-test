...
const initialArtworks: Artwork[] = [
  {
    ...
    description: "Concept Book Cover inspired by a hill near my house. It was digitally painted over the course of two days. A big emphasis was placed on creating a whimsical and tranquil tone, as well as detailed rendering in foliage.",
  ...
  },
 {
  ...
  },
   {
    ...
    year: "2025",
    medium: "Book Cover - Personal Project",
    description: "Concept book cover focused on exploration of rendering technique as well as speed. Painted entirely in 2 hours, what was supposed to be simple practice turned into something to be rather proud of.",
...

{
    ...
    description: "Concept character key art for an original character. This piece aimed to find the harmony between the soft rendering of the background with the character's emphasized prominent linework.",
...

{
    ...
    year: "2025",
    medium: "Book Cover - Personal Project",
    description: "Concept book cover vaguely inspired by a conversation with a friend. The illustration explores my soft and painterly style paired with a much darker colour palette.",
...

  {
    ...
    year: "2025",
    medium: "Book Cover - Personal Project",
    description: "Concept book cover made during... well... a rather quaint summer morning :D The illustration began as a simple profile study but then evolved as the warm mellow of the day took more real estate in my mind.",
...

  {
...

   {
    ...
    description: "A very technical study of rendering clouds to understand form as well as creating varying weight from the same subject.",
...

  {
    ...
    year: "2024",
    medium: "Key art | Tassena",
    description: "Key promotional art for the game Tassena. These were used in general art direction, posters, social media, in-person events, and crowdfunding ventures.",
