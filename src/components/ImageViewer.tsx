    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[100vw] md:max-w-[95vw] h-[100vh] md:h-[95vh] p-0 overflow-hidden bg-whimsical-soft/95 backdrop-blur-sm border-2 border-whimsical-border/30">
        <div className="flex h-full">
          ...
          <div className="flex-1 relative flex items-center justify-center p-4 bg-gradient-to-br from-whimsical-soft/50 to-whimsical-accent/20 overflow-hidden">
            <div className="w-full h-full flex items-center justify-center">
              <img 
                src={currentImage} 
                alt={`${artwork.title} - Image ${currentImageIndex + 1}`}
                className="max-w-full max-h-full w-auto h-auto object-contain rounded-lg shadow-2xl animate-fade-in" 
                style={{
            ...
            {hasMultipleImages && (
              <>
                <Button
                  variant="secondary"
                  size="icon"
                  className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white text-black shadow-lg"
                ...
                <Button
                  variant="secondary"
                  size="icon"
                  className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white text-black shadow-lg"
                  onClick={goToNext}
                >
            ...
            <div className="flex-1 space-y-3">
              ...
              <div className="space-y-2 text-muted-foreground">
                <p className="text-xs leading-relaxed">
                  This artwork represents a unique exploration of form and color, 
